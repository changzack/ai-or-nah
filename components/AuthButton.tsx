...
export function AuthButton({ onBuyMore, onSignIn }: AuthButtonProps) {
  ...
  if (!isAuthenticated) {
    return (
      <motion.button
        onClick={onSignIn}
        className="bg-[#8B5CF6] text-white px-4 py-2 rounded-full font-bold text-sm hover:bg-[#7C3AED] transition-colors"
  ...
  // Authenticated - show Credit Badge with dropdown
  return (
